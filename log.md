...
* **Initialization**: Established the bundle structure (directories, index
  files, site configuration) and adapted `rules.md` for the ISW
  Russia-Ukraine source stream. No concepts created yet; the first source
  incorporation will seed the corpus.

## 2026-07-26

* **Incorporation**: Processed ISW [Russian Offensive Campaign Assessment, January 2, 2025](https://understandingwar.org/research/russia-ukraine/russian-offensive-campaign-assessment-january-2-2025/).
  Created the [Russia-Ukraine War]({{ site.baseurl }}/conflicts/russia-ukraine-war.html) conflict concept;
  actor concepts for [Russia]({{ site.baseurl }}/actors/countries/russia.html),
  [Ukraine]({{ site.baseurl }}/actors/countries/ukraine.html),
  [Moldova]({{ site.baseurl }}/actors/countries/moldova.html),
  [Iran]({{ site.baseurl }}/actors/countries/iran.html),
  [Belarus]({{ site.baseurl }}/actors/countries/belarus.html),
  [Institute for the Study of War]({{ site.baseurl }}/actors/organizations/institute-for-the-study-of-war.html),
  [Gazprom]({{ site.baseurl }}/actors/organizations/gazprom.html), and
  [Volodymyr Zelensky]({{ site.baseurl }}/actors/volodymyr-zelensky.html);
  region concepts for the
  [Kursk direction]({{ site.baseurl }}/regions/kursk-direction.html),
  [Kharkiv direction]({{ site.baseurl }}/regions/kharkiv-direction.html),
  [Kupyansk-Svatove-Kreminna line]({{ site.baseurl }}/regions/kupyansk-svatove-kreminna-line.html),
  [Siversk axis]({{ site.baseurl }}/regions/siversk-axis.html),
  [Chasiv Yar direction]({{ site.baseurl }}/regions/chasiv-yar-direction.html),
  [Toretsk direction]({{ site.baseurl }}/regions/toretsk-direction.html),
  [Pokrovsk direction]({{ site.baseurl }}/regions/pokrovsk-direction.html),
  [Kurakhove direction]({{ site.baseurl }}/regions/kurakhove-direction.html),
  [Vuhledar direction]({{ site.baseurl }}/regions/vuhledar-direction.html),
  [Zaporizhia direction]({{ site.baseurl }}/regions/zaporizhia-direction.html),
  [Kherson direction]({{ site.baseurl }}/regions/kherson-direction.html),
  [Crimea]({{ site.baseurl }}/regions/crimea.html), and
  [Belarus]({{ site.baseurl }}/regions/belarus.html);
  theme concepts for the
  [Russian air, missile, and drone campaign]({{ site.baseurl }}/themes/russian-air-missile-drone-campaign.html),
  [Ukraine's strike campaign]({{ site.baseurl }}/themes/ukraines-strike-campaign.html),
  [Russian war economy and energy]({{ site.baseurl }}/themes/russian-war-economy-energy.html),
  [Russian mobilization and force generation]({{ site.baseurl }}/themes/russian-mobilization-force-generation.html),
  [Russian technological adaptations]({{ site.baseurl }}/themes/russian-technological-adaptations.html), and
  [Black Sea naval operations]({{ site.baseurl }}/themes/black-sea-naval-operations.html);
  and event concepts for
  [Ukraine ends Russian gas transit]({{ site.baseurl }}/events/ukraine-gas-transit-cessation-2025.html),
  [Ukrainian missile strike on Kursk command post]({{ site.baseurl }}/events/ukrainian-missile-strike-kursk-2025-01-02.html),
  [Ukrainian naval drone strike on Russian helicopters]({{ site.baseurl }}/events/ukrainian-naval-drone-strike-black-sea-2024-12-31.html),
  [Russia ZNPP licensing plan]({{ site.baseurl }}/events/russia-znpp-licensing-plan-2025.html), and
  [Russia-Iran Strategic Partnership Agreement]({{ site.baseurl }}/events/russia-iran-strategic-partnership-agreement-2025.html).
